...
public class medActivity extends AppCompatActivity {
    ...
    public int totalimages = 16; //to track if any images are still open and go to results when none are open
    public List<Integer> generated = new ArrayList<Integer>();

    //Using only eight images since this is a 4x4 and each image must be shown twice to complete the game
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Only sixteen images (8 pairs) are needed for this complexity level
        for(int i=0;i<8;i++){
            ...
            while(count < 2){
                ...
                //After the end of this loop images will have sixteen images ( 8 pairs) to load
                Integer p1 = rng.nextInt(16) ;
                //if the number was already used, don't use it
                if(!generated.contains(p1)){
                    generated.add(p1);
                    images[p1] = imagesource[pic];
                    Log.d("Med:ImagePosition",p1.toString());
                    count++;
                }
            }
        }
        ...
        for (int i=0; i<column*column; i++){
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //Increment the score
                    score++;
                    TextView tx = (TextView) findViewById(R.id.medScoretxtView);
                    ...
                    //There is already an image open
                        ...
                        if(lastimage_id == images[next])
                        {
                            ...
                            if(totalimages == 0){
                                ...
                                Intent result = new Intent(medActivity.this,activity_score.class);
                                result.putExtra("Level","Medium");
                                result.putExtra("BestScore","16");
