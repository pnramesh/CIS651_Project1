...
public class hardActivity extends AppCompatActivity {
    ...
    public int totalimages = 36; //to track if any images are still open and go to results when none are open
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //All 36 images (18 pairs) are needed for this complexity level
        for(int i=0;i<18;i++){
            ...
            while(count < 2){
                //36 is the maximum number of imageviews for this difficulty level
                //Each image from imagesource will be placed in two locations in images
                //After the end of this loop images will have thirty six images (18 pairs) to load
                Integer p1 = rng.nextInt(36) ;
        ...
        GridLayout gridLayout = findViewById(R.id.hardLayout);
        ...
        for (int i=0; i<column*column; i++){
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //Increment the score
                    score++;
                    TextView tx = (TextView) findViewById(R.id.hardScoretxtView);
                    ...
                    //There is already an image open
                        ...
                        if(lastimage_id == images[next])
                        {
                            ...
                            if(totalimages == 0){
                                ...
                                Intent result = new Intent(hardActivity.this,activity_score.class);
                                result.putExtra("Level","Hard");
                                result.putExtra("BestScore","36");
